...
interface NavItem {
  ...
  label: string;
  /** Optional advanced/lore name (e.g. "Chat"). Shown as subtitle. */
  subtitle?: string;
  accent: string;
  accentDim: string;
  icon: ReactNode;
...
const PRIMARY: NavItem[] = [
  ...
  {
    href: "/chat",
    label: MODULE_TERMINOLOGY.chat.friendlyLabel,
    subtitle: MODULE_TERMINOLOGY.chat.latinName,
    accent: "#4df5c8",
  ...
  {
    href: "/workshop",
    label: MODULE_TERMINOLOGY.workshop.friendlyLabel,
    subtitle: MODULE_TERMINOLOGY.workshop.latinName,
    accent: "#fb923c",
    accentDim: "rgba(251,146,60,0.18)",
    icon: <WorkshopIcon />,
    hint: termHint("workshop"),
  },
  {
    href: "/notebook",
    label: MODULE_TERMINOLOGY.notebook.friendlyLabel,
    subtitle: MODULE_TERMINOLOGY.notebook.latinName,
    accent: "#7bffdd",
    accentDim: "rgba(123,255,221,0.18)",
    icon: <NotebookIcon />,
    hint: termHint("notebook"),
  },
  {
    href: "/notebook?focus=more-input",
  ...
  {
    href: "/vision",
    label: MODULE_TERMINOLOGY.vision.friendlyLabel,
    subtitle: MODULE_TERMINOLOGY.vision.latinName,
    accent: "#bc8cff",
    accentDim: "rgba(188,140,255,0.18)",
    icon: <VisionIcon />,
    hint: termHint("vision"),
  },
  {
    href: "/activity-log",
  ...
  {
    href: "/insights",
    label: MODULE_TERMINOLOGY.insights.friendlyLabel,
    subtitle: MODULE_TERMINOLOGY.insights.latinName,
    accent: "#60a5fa",
    accentDim: "rgba(96,165,250,0.18)",
    icon: <InsightsIcon />,
    hint: termHint("insights"),
  },
];
