        ...
        <section>
          ...
          <div className="space-y-3">
            <SettingToggle
              ...
              description="Show short teaching notes alongside model answers in Chat."
