...
export default function WelcomePage() {
  ...
  function continueAsBefore() {
    ...
    router.push(mode === "on" ? "/chat?tour=1" : "/chat");
  }
  ...
  return (
    <AppPageShell
      ...
      intro="Full name Pehlichi, but Peh is fine. I'm a friendly guide that runs right here on your device — curious, a little eccentric, and honest about what I can and can't do. Take a 60-second guided tour, or jump straight into Chat."
      accent="#bc8cff"
      headerRight={
        <span
          style={{
