  ...
  steps: [
    {
      ...
      body: '"Notebook" means archive or records. This is your local knowledge shelf for notes, snippets, and pasted documents.',
    },
    {
      id: "more-input",
    ...
    },
    {
      ...
      body: "Notebook stores entries in this browser. There is no cloud sync, vector database, or background import.",
    },
    {
      id: "entries",
