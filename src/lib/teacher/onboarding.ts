/**
 * Onboarding stages for Public Squidley's teaching flow.
 *
...
export const ONBOARDING_STAGES: readonly OnboardingStage[] = [
  {
    ...
    objective: "Understand that Squidley is a teacher that helps you learn how AI agents work.",
    requiredConcepts: [],
    userAction: "Read the welcome screen and click Continue.",
    squidleyExplanation: "Hi, I'm Squidley. I'm going to teach you how AI agents work — starting right here on your own machine, where everything stays private and free. I'll explain every step as we go.",
  ...
  },
  {
    ...
    squidleyExplanation: "A chatbot just generates text. An agent can plan, use tools, and take real actions — like reading files, writing code, or searching the web. I'm designed to be an agent, but I start you in Local Mode where I only generate text. As you learn more, I'll unlock more capabilities.",
  ...
  },
  {
    ...
    squidleyExplanation: "Right now I'm running in Local Mode. That means I'm using a model installed on your computer — nothing leaves your machine. I need Ollama running with a model installed. Let me check if that's ready.",
  ...
  },
  {
    ...
    userAction: "Send a message to Squidley in Colloquium.",
    squidleyExplanation: "You just sent me a prompt and I responded. My answer came from the local model running on your machine. I did not read any files, search the web, or contact any server. Look at the footer below my answer — it says 'local model only, no cloud, no tool.' That's my provenance — proof of where the answer came from.",
  ...
  },
  {
    ...
    squidleyExplanation: "Every answer I give has a provenance footer. It tells you: which mode I'm in (local or cloud), which model answered, whether I called a cloud server, and whether I used any tools. You can also check the Tabularium for a full receipt of what happened.",
  ...
  },
  {
    ...
    squidleyExplanation: "Not all actions are equally risky. Reading a file is medium risk. Writing a file or running a command is high risk. For high-risk actions, I will always stop and ask your permission first. Even in Cloud Mode, I never skip approval gates. You are always in control.",
  ...
  },
  {
    ...
    objective: "Understand how receipts prove what Squidley actually did.",
    requiredConcepts: ["receipt", "tabularium", "provenance"],
    userAction: "Open Tabularium and read a receipt.",
    squidleyExplanation: "Every action I take gets a receipt. The receipt shows: what happened, which model was used, whether cloud was called, whether tools were used, and when. Receipts are stored in your browser. They are my proof — if I say I did something, the receipt confirms it. If there is no receipt, it did not happen.",
  ...
  },
  {
    ...
    squidleyExplanation: "Before I make a cloud call, I will show you what will be sent and ask your consent. After the call, a receipt is created showing the provider, model, and that cloud was used. You can see exactly what happened.",
  ...
  },
  {
    ...
    userAction: "Ask Squidley to read a file (read-only tool).",
    squidleyExplanation: "I just used a tool to read a file from your project. This is different from just talking about it — I actually opened the file and read its contents. The receipt shows what file was read and when. No files were changed.",
  ...
  },
  {
    ...
    userAction: "Ask Squidley to complete a simple multi-step task.",
    squidleyExplanation: "For this task, I will make a plan, show it to you, and then execute each step. At key points I will ask for your approval before doing anything risky. Every step produces a receipt. At the end, you can review the full audit trail.",
