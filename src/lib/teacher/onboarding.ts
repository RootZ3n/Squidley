...
export const ONBOARDING_STAGES: readonly OnboardingStage[] = [
  ...
  },
  {
    ...
    userAction: "Send a message to Peh in Chat.",
  ...
  },
  {
    ...
    userAction: "Read the provenance footer on a chat response. Open ActivityLog.",
    pehExplanation: "Every answer I give has a provenance footer. It tells you: which mode I'm in (local or cloud), which model answered, whether I called a cloud server, and whether I used any tools. You can also check the ActivityLog for a full receipt of what happened.",
    completionCriteria: "User has read a provenance footer and opened ActivityLog.",
  ...
  },
  {
    ...
    requiredConcepts: ["receipt", "activity-log", "provenance"],
    userAction: "Open ActivityLog and read a receipt.",
    ...
    completionCriteria: "User has opened ActivityLog and read at least one receipt.",
