...
export const RUNTIME_TEACHING_HOOKS: readonly RuntimeTeachingHook[] = [
  ...
  },
  {
    ...
    conceptIds: ["receipt", "activity-log"],
    whatHappened: "A receipt was created for an action Peh took.",
    whyItMatters: "Receipts are proof of what happened. You can review them any time in the ActivityLog to verify what Peh did.",
    whatYouCanDoNext: "Open ActivityLog to see the receipt. It shows the mode, model, cloud status, and tools used.",
  ...
  },
  {
    ...
    whatYouCanDoNext: "Check the receipt in ActivityLog to verify the tool action.",
    docsLink: "docs/teacher-kb/06-tool-calls.md",
  },
  {
