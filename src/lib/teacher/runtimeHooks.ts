/**
 * Runtime teaching hooks for Public Squidley.
 *
...
export const RUNTIME_TEACHING_HOOKS: readonly RuntimeTeachingHook[] = [
  {
    ...
    whatHappened: "Squidley started in a specific operating mode.",
    whyItMatters: "The mode determines what Squidley can do. Local Mode is private and free. Cloud Mode adds powerful capabilities but costs money and sends data over the internet.",
    whatYouCanDoNext: "Chat with Squidley in the current mode. Check the mode badge to see which mode is active.",
  ...
  },
  {
    ...
    whyItMatters: "Squidley can now use this provider's models. Calls will cost money based on token usage. Your text will be sent to the provider's servers.",
  ...
  },
  {
    ...
    whyItMatters: "Cloud models require an API key — a password that lets Squidley talk to a provider's servers. API keys are tied to your account and cost money per use.",
  ...
  },
  {
    ...
    whatHappened: "Squidley is asking your consent before making a cloud call.",
    whyItMatters: "Your text will be sent to a cloud provider's server. This costs money and means your data leaves your machine. Squidley always asks before doing this.",
  ...
  },
  {
    ...
    whatHappened: "Squidley wants to use a tool to take a real action.",
    whyItMatters: "A tool call is a real action — not just text generation. Depending on the risk level, Squidley may need your approval first.",
  ...
  },
  {
    ...
    whyItMatters: "Some tools are only available in Cloud Mode, and some are not implemented yet. Squidley tells you honestly what she cannot do.",
  ...
  },
  {
    ...
    whatHappened: "Squidley is asking your permission before taking a risky action.",
    ...
    whatYouCanDoNext: "Read what Squidley wants to do, then approve or deny. Your choice is recorded in the receipt.",
  ...
  },
  {
    ...
    whatYouCanDoNext: "Continue chatting. Squidley will not retry the denied action unless you ask.",
  },
  {
    event: "approval_granted",
    conceptIds: ["approval", "receipt"],
    whatHappened: "You approved an action. Squidley will now execute it.",
  ...
  },
  {
    ...
    whatHappened: "A receipt was created for an action Squidley took.",
    whyItMatters: "Receipts are proof of what happened. You can review them any time in the Tabularium to verify what Squidley did.",
  ...
  },
  {
    ...
    whyItMatters: "The failure is recorded honestly in the receipt. Squidley does not pretend a failed action succeeded.",
  ...
  },
  {
    ...
    whyItMatters: "Squidley needs a running local model server to work in Local Mode. The most common issue is that Ollama is not running.",
  ...
  },
  {
    ...
    whyItMatters: "Squidley tells you honestly when she cannot do something. The capability matrix shows what is available now and what is planned.",
  ...
  },
  {
    ...
    whyItMatters: "Diagnostics ensure Squidley is working correctly and honestly. A failure means something needs to be fixed before the system is reliable.",
    whatYouCanDoNext: "Check the diagnostic output for details. Common issues: Ollama not running, model not installed.",
    docsLink: "docs/teacher-kb/12-using-squidley-safely.md",
  },
  {
