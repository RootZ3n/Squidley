...
const PLANNING_PATTERNS: readonly RegExp[] = [
  ...
  /\bhow (?:would|should) (?:you|i|peh|squidley) (?:fix|approach|tackle|handle|change|modify|update)\b/i,
  /\bwhat (?:should|would) (?:i|you|we) (?:change|modify|update|do)\b/i,
  /\bwhat files (?:are|might be) involved\b/i,
  /\bwhat files (?:should|would) (?:i|we|peh|squidley) (?:look at|inspect|check)\b/i,
  /\bhow hard would (?:this|that|it) be\b/i,
  /\bwhat would (?:peh|squidley) need to (?:inspect|read|look at)\b/i,
