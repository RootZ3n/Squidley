...
const PLANNING_PATTERNS: readonly RegExp[] = [
  ...
  /\bhow (?:would|should) (?:you|i|squidley) (?:fix|approach|tackle|handle|change|modify|update)\b/i,
  /\bwhat (?:should|would) (?:i|you|we) (?:change|modify|update|do)\b/i,
  /\bwhat files (?:are|might be) involved\b/i,
  /\bwhat files (?:should|would) (?:i|we|squidley) (?:look at|inspect|check)\b/i,
  /\bhow hard would (?:this|that|it) be\b/i,
  /\bwhat would squidley need to (?:inspect|read|look at)\b/i,
