/**
 * Cloud consent decision receipt helpers and ActivityLog adapter.
 *
...
export function cloudConsentToActivityReceiptInput(
  event: CloudConsentReceiptEvent,
  options: CloudConsentReceiptOptions = {},
...
export function createCloudConsentActivityReceipt(
  event: CloudConsentReceiptEvent,
  options: CloudConsentReceiptOptions = {},
): ActivityReceipt {
  return createActivityReceipt(
    cloudConsentToActivityReceiptInput(event, options),
  );
}

/**
 * Record a cloud consent decision through the existing local ActivityLog
