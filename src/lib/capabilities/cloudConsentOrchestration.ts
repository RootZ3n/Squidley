 ...
 *   - Storage writes only through supplied storage via logTabulariumReceipt.
...
export interface CloudConsentOrchestrationResult {
  ...
  decisionReceipt: TabulariumReceipt | null;
...
export function recordCloudEscalationOfferAndDecision(
  ...
  // --- Offer ---
  let offerReceipt: TabulariumReceipt | null = null;
  ...
  // --- Decision ---
  let decisionReceipt: TabulariumReceipt | null = null;
