...
import {
  ...
  createPromptInjectionAssessmentActivityReceipt,
...
describe("promptInjectionAssessmentToActivityReceiptInput", () => {
  ...
  it("metadata stays within ActivityLog cap of 16", () => {
...
describe("createPromptInjectionAssessmentActivityReceipt", () => {
  it("creates a valid ActivityReceipt", () => {
    const event = createPromptInjectionAssessmentReceiptEvent(
      assessPromptInjectionRisk("Normal text"),
    );
    const receipt = createPromptInjectionAssessmentActivityReceipt(event);
...
describe("prompt injection receipt helpers — purity", () => {
  ...
  it("no fetch/provider/model/cloud calls occur", () => {
    ...
    const event = createPromptInjectionAssessmentReceiptEvent(assessment);
    promptInjectionAssessmentToActivityReceiptInput(event);
    createPromptInjectionAssessmentActivityReceipt(event);
