/**
 * Gateway policy decision receipt helpers and ActivityLog adapter.
 *
...
export function gatewayPolicyDecisionToActivityReceiptInput(
  event: GatewayPolicyDecisionReceiptEvent,
...
export function createGatewayPolicyDecisionActivityReceipt(
  event: GatewayPolicyDecisionReceiptEvent,
  options: GatewayPolicyReceiptOptions = {},
): ActivityReceipt {
  return createActivityReceipt(
    gatewayPolicyDecisionToActivityReceiptInput(event, options),
  );
}

/**
 * Record a gateway policy decision through the existing local ActivityLog
