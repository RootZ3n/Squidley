...
export const STORAGE_KEY_ALIASES: readonly StorageKeyAlias[] = [
  { current: "peh.chat.conversation.v1", legacy: "squidley.colloquium.conversation.v1" },
  { current: "peh.chat.sessions.v2", legacy: "squidley.colloquium.sessions.v2" },
  { current: "peh.chat.velumDraft.v1", legacy: "squidley.colloquium.velumDraft.v1" },
  { current: "peh.notebook.entries.v1", legacy: "squidley.archivum.entries.v1" },
  { current: "peh.activity-log.receipts.v1", legacy: "squidley.tabularium.receipts.v1" },
  { current: "peh.nous.modelPreferences.v1", legacy: "squidley.nous.modelPreferences.v1" },
  { current: "peh.vision.chatAnalysis.v1", legacy: "squidley.oculus.colloquiumAnalysis.v1" },
