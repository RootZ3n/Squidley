...
import { buildNousModuleMap } from "./modelMap";
...
describe("Nous module map", () => {
  it("describes public modules and model roles", () => {
    ...
    const map = buildNousModuleMap({ preferences: prefs, models, configuredModel: "llama3.2" });
  ...
  it("marks Fabrica as an active single-file workshop without agent behavior", () => {
    const fabrica = buildNousModuleMap({
