...
import {
  ...
  type ActivityReceiptChain,
} from "./receiptChains";
import { createActivityReceipt, type ActivityReceipt } from "./receipts";
...
function makeReceipt(
  overrides: Partial<Parameters<typeof createActivityReceipt>[0]> & { action: string },
): ActivityReceipt {
...
// ---------------------------------------------------------------------------
// Velum receipts group with Workshop capabilityId chains
// ---------------------------------------------------------------------------
