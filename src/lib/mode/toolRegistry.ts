...
export const TOOL_REGISTRY: readonly ToolRegistryEntry[] = [
  ...
  // --- Vision ---
  {
    ...
    localStatus: "PARTIAL",
    cloudStatus: "NOT_IMPLEMENTED",
    implementationFile: "src/app/api/vision/analyze/route.ts",
  ...
  // --- Capability discovery (implemented locally) ---
  {
    ...
    localStatus: "READY",
    cloudStatus: "READY",
    implementationFile: "src/app/insights/page.tsx",
    canReadFiles: false,
    canWriteFiles: false,
    canRunCommands: false,
    canUseNetwork: false,
  ...
  // --- Notes storage (implemented locally) ---
  {
    ...
    localStatus: "READY",
    cloudStatus: "READY",
    implementationFile: "src/app/notebook/page.tsx",
    canReadFiles: false,
    canWriteFiles: false,
    canRunCommands: false,
    canUseNetwork: false,
  ...
  // --- Code suggestion (existing local) ---
  {
    ...
    localStatus: "READY",
    cloudStatus: "NOT_IMPLEMENTED",
    implementationFile: "src/app/api/workshop/suggest/route.ts",
