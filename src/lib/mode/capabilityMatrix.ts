...
export const MODE_CAPABILITY_MATRIX: readonly ModeCapabilityEntry[] = [
  ...
  },
  {
    ...
    localModeStatus: "READY",
    cloudModeStatus: "NOT_IMPLEMENTED",
    localImplementation: "src/app/api/workshop/suggest/route.ts",
    cloudImplementation: undefined,
    ...
    riskLevel: "low",
    approvalRequired: false,
    proofReferences: ["src/app/api/workshop/suggest/route.test.ts"],
    localProofReferences: ["src/app/api/workshop/suggest/route.test.ts"],
    cloudProofReferences: [],
  ...
  },
  {
    ...
    localModeStatus: "PARTIAL",
    cloudModeStatus: "NOT_IMPLEMENTED",
    localImplementation: "src/app/api/vision/analyze/route.ts",
    cloudImplementation: undefined,
    ...
    riskLevel: "low",
    approvalRequired: false,
    proofReferences: ["src/app/api/vision/analyze/route.test.ts"],
    localProofReferences: ["src/app/api/vision/analyze/route.test.ts"],
    cloudProofReferences: [],
  ...
  },
  {
    ...
    localImplementation: "src/app/notebook/page.tsx",
    cloudImplementation: "src/app/notebook/page.tsx",
  ...
  },
  {
    ...
    localImplementation: "src/app/insights/page.tsx",
    cloudImplementation: undefined,
