...
import { buildColloquiumCapabilityDecisionReceiptInput } from "./capabilityReceipts";
...
describe("Colloquium gateway — benign input", () => {
...
describe("Colloquium gateway — suspicious input", () => {
...
describe("Colloquium gateway — no raw text in receipt", () => {
...
describe("Colloquium gateway — existing receipts unaffected", () => {
  it("chat sent receipt still builds correctly", () => {
    const receipt = buildColloquiumChatSentReceipt({
      id: "r-1",
      createdAt: 1,
      model: "llama3.1:8b",
    });
  ...
  it("chat completed receipt still builds correctly", () => {
    const receipt = buildColloquiumChatCompletedReceipt({
      id: "r-1-c",
      createdAt: 1,
      completedAt: 2,
      receiptId: "r-1",
  ...
  it("chat failed receipt still builds correctly", () => {
    const receipt = buildColloquiumChatFailedReceipt({
      id: "r-1-f",
      createdAt: 1,
      completedAt: 2,
      model: "llama3.1:8b",
...
describe("Colloquium gateway — storage failure", () => {
...
describe("Colloquium gateway — purity", () => {
