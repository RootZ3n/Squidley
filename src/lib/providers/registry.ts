...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = [
  ...
  },
  {
    ...
    beginnerDescription:
      "A lightweight local inference server from llama.cpp. Peh has an OpenAI-compatible local text path for it; real llama-server binary validation is still pending, and Vision vision is not supported.",
    status: "active",
  },
  {
    id: "openrouter",
