import type { RatioDecision, RatioDecisionStatus } from "./types";

export function getRatioStatusLabel(status: RatioDecisionStatus): string {
  switch (status) {
    case "available":
      return "Available";
    case "limited":
...
export function getRatioUnlockLine(decision: RatioDecision): string | null {
