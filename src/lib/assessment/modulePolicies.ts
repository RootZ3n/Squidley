...
export const RATIO_MODULE_POLICIES: readonly AssessmentModulePolicy[] = [
  policy("colloquium", "chat.basic", "public-local", "active", "Chat can chat with a local model in public mode.", { minimumPlanningAbility: "basic" }),
  ...
  policy("fabrica", "workshop.single-file-suggestion", "public-local", "active", "Workshop can suggest one file at a time in public mode.", { minimumCodingAbility: "basic" }),
  policy("fabrica", "workshop.multi-file-build", "cloud-agent", "future", "Multi-file builds require Cloud Agent mode, workspace access, and approval.", { minimumCodingAbility: "agentic", minimumPlanningAbility: "agentic", requiresWorkspace: true, requiresTools: true, requiresApproval: true }),
  policy("oculus", "vision.local-image-analysis", "public-local", "active", "Vision can analyze a chosen image when a local vision model is selected.", { minimumVisionAbility: "basic" }),
  ...
  policy("archivum", "notebook.local-storage", "public-local", "active", "Notebook stores entries in this browser and does not need a model."),
  policy("archivum", "notebook.summarize", "cloud-assisted", "prepared", "Summarizing large local knowledge will need stronger model support later.", { minimumPlanningAbility: "multi-step" }),
  ...
  policy("nous", "insights.system-map", "public-local", "active", "Insights maps modules, providers, and Assessment capability decisions without calling a model."),
